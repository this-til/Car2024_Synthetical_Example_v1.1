...
public class TitleToolbar extends BaseToolbar implements View.OnClickListener {
    ...
    protected void initCustomView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (!isChild(mTitleTextView, mTitleLayout)) {
            ...
            @SuppressLint("RestrictedApi") int titleTextAppearance = a.getResourceId(androidx.appcompat.R.styleable.Toolbar_titleTextAppearance, 0);
            ...
            if (a.hasValue(androidx.appcompat.R.styleable.Toolbar_titleTextColor)) {
                int titleColor = a.getColor(androidx.appcompat.R.styleable.Toolbar_titleTextColor, Color.WHITE);
            ...
            setTitle(a.getText(androidx.appcompat.R.styleable.Toolbar_title));
        ...
        if (!isChild(mSubtitleTextView, mTitleLayout)) {
            ...
            int subTextAppearance = a.getResourceId(androidx.appcompat.R.styleable.Toolbar_subtitleTextAppearance, 0);
            ...
            if (a.hasValue(androidx.appcompat.R.styleable.Toolbar_subtitleTextColor)) {
                int subTitleColor = a.getColor(androidx.appcompat.R.styleable.Toolbar_subtitleTextColor, Color.WHITE);
            ...
            setSubtitle(a.getText(androidx.appcompat.R.styleable.Toolbar_subtitle));
            setSubtitleVisible(
