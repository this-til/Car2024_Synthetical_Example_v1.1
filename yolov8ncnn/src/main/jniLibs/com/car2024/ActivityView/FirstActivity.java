...
import car.bkrc.com.car2024.FragmentView.RightFragment1;
...
public class FirstActivity extends AppCompatActivity {
    ...
    // 摄像头IP
    public static String IPCamera = null; // 带端口号
    public static String purecameraip = null; // 不带端口号
    ...
    private void autoDriveAction() {
        ...
        builder.setPositiveButton("开始", (dialog, which) -> {
            Thread thread = new Thread(new Runnable() {
                ...
                public void run() {
                    // 在这里执行后台操作
                    // 注意：不要在这里更新UI，因为这个线程是在后台执行的
                    Connect_Transport.line(50);
                    Connect_Transport.yanchi(2000);
                    Connect_Transport.go(37,250);
                    ...
                    //TrafficUtils.HoughCircleCheck(picBitmap,getContext(),0x0E,null,null);
                    ...
                    Connect_Transport.back(30,600);
                    Connect_Transport.yanchi(2000);

                    //            Connect_Transport.yanchi(5000);
//            Connect_Transport.go(50, 200);
//            Connect_Transport.yanchi(5000);
//            Connect_Transport.go(50, 200);
//            Connect_Transport.yanchi(5000);
